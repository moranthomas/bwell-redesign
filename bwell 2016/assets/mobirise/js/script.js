    ...
    $(function () {
        ...
        $(window).scroll(function () {
            $('.bwell-navbar--sticky').each(function () {
                var method = $(window).scrollTop() > 100 ? 'addClass' : 'removeClass';
                $(this)[method]('bwell-navbar--stuck').not('.bwell-navbar--open')[method]('bwell-navbar--short');
            });
        });
        //Thomas VERSION - not fully working yet
        // .bwell-navbar--sticky
        /*$(window).scroll(function(){
            $('.bwell-navbar__sticky').each(function(){
                var method = $(window).scrollTop() > 100 ? 'addClass' : 'removeClass';
                //$(this)[method]('bwell-navbar--stuck').not('.bwell-navbar--open')[method]('bwell-navbar--short');
        ...
        $(document).on('add.cards change.cards', function (event) {
            $(event.target).outerFind('.mbr-hamburger:not(.mbr-added)').each(function () {
                ...
                }).parents('.bwell-navbar').find('a:not(.mbr-hamburger)').click(function () {
